...
namespace SharpSub.UI.Demo
{
    public partial class Form1 : Form
    {
        ...
        {
            InitializeComponent();
            const string SERVER_URL = "bmjones.com:56565/music";
            //string USERNAME = "Guest";
            //string password = "notbrett";
            string USERNAME = "Brett";
            string password = "::1212Gh";
            SubsonicResponse loginResponse = SubsonicRequest.Login(SERVER_URL, USERNAME, password);
        ...
        private void albumsListBox_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            ThreadPool.QueueUserWorkItem((ShowAlbumArt), album);
            ThreadPool.QueueUserWorkItem((ShowSongs), album);
        }

        private void ShowAlbumArt(object album)
        {
            var image = (album as Album).CoverArt;
