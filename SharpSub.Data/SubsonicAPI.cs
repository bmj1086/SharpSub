...
namespace SubsonicAPI
{
    ...
    public static class Subsonic
    {
        ...
        {
            string requestURL = String.Format(@"http://{0}/rest/{1}?&v={2}.0&c={3}",
                                          server, method, ConfigurationManager.AppSettings["RestVersion"], ConfigurationManager.AppSettings["AppName"]);
